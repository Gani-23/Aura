...
Correlated session summary: Session key: process:python; event count: 2; targets seen: api.stripe.com, malicious.example.com; processes: python; correlation fields: process.
...
- Session process:python observed 2 events across targets: api.stripe.com, malicious.example.com

...
Correlated session summary: Session key: request_id:req-123; event count: 2; targets seen: api.stripe.com, malicious.example.com; processes: python; correlation fields: request_id, trace_id, span_id, process.

...
Correlated session summary: Session key: process:python:1234; event count: 1; targets seen: malicious.example.com; processes: python; correlation fields: process.
...
- Session process:python:1234 observed 1 events across targets: malicious.example.com
